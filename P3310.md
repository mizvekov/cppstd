...
::: add
[3]{.pnum} Partial ordering considers first the set of templates for which there is no strict-pack-match ([temp.deduct.type]/9.1), possibly including the primary template. If there is no viable template in this first set, partial ordering considers the rest.
