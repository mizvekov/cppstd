...
::: add
[3]{.pnum} When deducing the argument list of X as specified in [temp.arg.template]/4, partial ordering considers first the set of templates which do not apply [temp.deduct.type]/9.1, possibly including the primary template. If there is no viable template in this first set, partial ordering considers the rest.
:::
