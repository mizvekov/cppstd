...
::: add
[3]{.pnum} When deducing the argument list of X as specified in [temp.arg.template]/4, partial ordering considers first the set of templates which do not apply [temp.deduct.type]{.sref}/9.2, possibly including the primary template. If there is no viable template in this first set, partial ordering considers the rest.
:::
...
::: add
[2.4]{.pnum} When deducing the argument list of X as specified in [temp.arg.template]/4, F1 does not apply [temp.deduct.type]{.sref}/9.1, and F2 does.
