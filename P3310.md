...
This deduced template must have a different type than the underlying template A, in case any
...
Where this means, take the template name `A`, and modify it by applying the following template arguments as defaults, starting from
